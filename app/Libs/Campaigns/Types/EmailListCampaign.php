...
class EmailListCampaign implements Campaign {
    ...
    {
        return "Runs when ever lead is added to a selected email list";
    }

    public static function getLeads($campaign)
    {
        return LeadSegment::where('segment_id', $campaign->segment_id)->join('leads', 'leads.id', 'lead_segments.lead_id')->select('leads.*');
    }
